...
public class Roles extends TableImpl<RolesRecord> {
    ...
    private static final long serialVersionUID = -619162896;

    /**
     * The reference instance of <code>Technical Thursday.roles</code>
     */
    ...
    /**
     * The column <code>Technical Thursday.roles.id</code>.
     */
    public final TableField<RolesRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>Technical Thursday.roles.role</code>.
     */
    public final TableField<RolesRecord, String> ROLE = createField(DSL.name("role"), org.jooq.impl.SQLDataType.VARCHAR(40).nullable(false), this, "");

    /**
     * Create a <code>Technical Thursday.roles</code> table reference
     */
    public Roles() {
    ...
    /**
     * Create an aliased <code>Technical Thursday.roles</code> table reference
     */
